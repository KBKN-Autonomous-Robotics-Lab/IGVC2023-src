...
class GPSGoalSetter:
  ...
  """
  ++++++++++++++++++++++++++++++++++
      update_node_flag function
  ++++++++++++++++++++++++++++++++++
  Set node_flag to 3, if the goal is to reach waypoint2 or waypoint3.
  Set node_flag to 1, if the goal is to reach waypoint1 or waypoint4.
  """
  def update_node_flag(self, num):
    if num == 2 or num == 3:
      rospy.set_param("node_flag", 3)
      node3_msg = """
###################
  Node3 started!!
###################
"""
      print("\033[35m" + node3_msg + "\033[0m")
    else:
...
###################
"""
      print("\033[35m" + node1_msg + "\033[0m")
...
"""
        ...
        while not self.goal_arrival_flag(waypoints, waypoints_goal_num,1.0):
          rospy.sleep(1)
        self.update_node_flag(waypoints_goal_num)
      rospy.sleep(1)
"""
++++++++++++++++++++++++++++++++++
              main
