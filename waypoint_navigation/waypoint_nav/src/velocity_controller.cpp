...
public:
  VelocityController()
      : move_base_action_("move_base", true), standard_vel_(1.0),
        current_max_vel_(1.0), min_vel_(0.0) {
    ...
    ros::NodeHandle nh;
    max_vel_sub_ =
        nh.subscribe("/max_vel", 1, &VelocityController::maxVelCallback, this);
    cmd_vel_sub_ = nh.subscribe("/cmd_vel_in", 100,
                                &VelocityController::cmdVelCallback, this);
