...
class GPSDataToxyz:
    def __init__(self):
        ...
        self.input_file = (
            "/home/ubuntu/catkin_ws/src/igvc2023/config/gps_parameters.yaml"
        )
        ...
        while count < 30:
            ...
            if talker_ID != -1:
                ...
                if latitude_data == b"":
                    ...
                    latitude_minute = (
                        float(latitude_data[0:2]) + float(latitude_data[2:]) / 60
                    )
                if longitude_data == b"":
                    ...
                    longitude_minute = (
                        float(longitude_data[0:3]) + float(longitude_data[3:]) / 60
                    )
  ...
  """
    ...
    def main(self):
        ...
        waypoints = [
            self.conversion(each, initial_coordinate, self.theta)
            for each in self.given_data
        ]
