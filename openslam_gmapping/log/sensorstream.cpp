...
#include <assert.h>
#include <sstream>
//#define LINEBUFFER_SIZE 1000000 //for not Cyrill to unbless me, it is better
//to exagerate :-))
...
SensorReading *SensorStream::parseReading(std::istream &is,
...
OdometryReading *SensorStream::parseOdometry(std::istream &is,
...
RangeReading *SensorStream::parseRange(std::istream &is,
