...
public:
  ...
  void drawPoints(const Iterator &begin, const Iterator &end, unsigned char r,
...
template <typename Cell>
void QMapPainter::setPixmap(unsigned int xsize, unsigned int ysize,
                            Cell **values) {
  QSize s(xsize, ysize);
  m_pixmap->resize(s);
...
template <typename Iterator>
void QMapPainter::drawPoints(const Iterator &begin, const Iterator &end,
